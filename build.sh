...
build_one "heap0" false true
build_one "heap1" false true
build_one "heap2" false true
build_one "heap3" false true
build_one "stack0" false true
build_one "stack1" false true
build_one "stack2" false true
build_one "stack3" false true
build_one "stack4" false true
build_one "stack5" false true
build_one "stack6" false true
build_one "stack7" false true
